...
class LoginState  extends State<Login>{
      ...
      body: new Container(
          ...
          new Column(
            ...
            children: [
              ...
              new  Image.asset('images/logo2.png'  , height: 200, width: 200,),
              orgIdEdFun() ,
              userNameEdFun(),
              passEdFun(),
              sendRequestBtn(),
  ...
  void onSendRequestBtn() {
    setState(() async {
     ...
     // sharedPrefs.setStringList(DOCUMENTS , Documents.createDocumentsList() );
  ...
  Padding orgIdEdFun() {
    return new Padding(padding:
    EdgeInsets.only(bottom: 8.0, left: 40.0, right: 40.0, top: 20.0),
        child:
        new Container(
            width: double.infinity,
            child : new Row(
